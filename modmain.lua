...
--						print("name2",name2)
	...
	AddClassPostConstruct("widgets/characterselect", function(self)
		local charlist = {wortox=1,winona=1,wickerbottom=1,waxwell=1,willow=1,wilson=1,woodie=1,wes=1,wolfgang=1,wendy=1,wathgrithr=1,webber=1,wormwood=1}
	...
	local function ChangeNamesTex(module)
		AddClassPostConstruct(module, function(self)
			local charlist = {winona=1,wx78=1,waxwell=1,wickerbottom=1,willow=1,wilson=1,woodie=1,wes=1,wolfgang=1,wendy=1,wathgrithr=1,webber=1,wormwood=1,wortox=1,random=1}
			local texnames = {}
	...
	AddClassPostConstruct("widgets/playeravatarpopup", function(self)
		local charlist = {winona=1,wx78=1,waxwell=1,wickerbottom=1,willow=1,wilson=1,woodie=1,wes=1,wolfgang=1,wendy=1,wathgrithr=1,wormwood=1,webber=1,wortox=1,random=1}
		local texnames = {}
		for name in pairs(charlist) do texnames["names_"..name] = name end
